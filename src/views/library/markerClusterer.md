...
const getStyles = () => {
  return [{
    ...
    size: BMapUtil.BSize({width: 32, height: 32}),
    // anchor: BMapUtil.BSize({width: 32, height: 32}),
    // offset: BMapUtil.BSize({width: 24, height: 24}),
    textSize: 24,
    textColor: 'red',
  }];
};
